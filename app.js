...
const urlLink = 'https://docs.google.com/presentation/d/1Ryo64FmYSiQPRT7CdavwOkevNBikc4mjkoVOKcrZCEw/edit?usp=sharing'
...
app.get('**', async (req, res) => {
  ...
  switch (req.url) { // checks url
    ...
    case '/slide':
      const slide = urlLink
      return res.redirect(slide) // redirects to another external link
    default:
